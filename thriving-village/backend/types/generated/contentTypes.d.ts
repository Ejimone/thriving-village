...
export interface ApiActivityLogActivityLog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    what: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiBrandBrand extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    kind: Schema.Attribute.Enumeration<['Sister business', 'Partner']> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiContestEntryContestEntry
  extends Struct.CollectionTypeSchema {
  collectionName: 'contest_entries';
  info: {
    displayName: 'Contest Entry';
    pluralName: 'contest-entries';
    singularName: 'contest-entry';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::contest-entry.contest-entry'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    ...
    status: Schema.Attribute.Enumeration<
      ['Submitted', 'Shortlisted', 'Won', 'Not selected']
    > &
      Schema.Attribute.Required &
    ...
    work: Schema.Attribute.Media<'files' | 'images'>;
  };
}
...
export interface ApiContestContest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    entries: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<0>;
    field: Schema.Attribute.Enumeration<
      ['Digital', 'Technical', 'Craft', 'Creative']
    > &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    > &
      Schema.Attribute.Private;
    prizes: Schema.Attribute.Component<'contest.prize', true>;
    publishedAt: Schema.Attribute.DateTime;
    rules: Schema.Attribute.JSON & Schema.Attribute.Required;
    seed: Schema.Attribute.String;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
    status: Schema.Attribute.Enumeration<['live', 'past']> &
      Schema.Attribute.Required &
...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    delivery: Schema.Attribute.Enumeration<['Online', 'Onsite', 'Hybrid']> &
      Schema.Attribute.Required;
    field: Schema.Attribute.Enumeration<
      ['Digital', 'Technical', 'Craft', 'Creative']
    > &
    ...
    instructorRole: Schema.Attribute.String & Schema.Attribute.Required;
    kind: Schema.Attribute.Enumeration<['Course', 'Certification']> &
      Schema.Attribute.Required;
    level: Schema.Attribute.Enumeration<['Entry', 'Mid', 'Senior']> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    weeks: Schema.Attribute.Integer & Schema.Attribute.Required;
  };
}
...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  collectionName: 'jobs';
  info: {
    description: 'A job listing on the board';
    displayName: 'Job';
    pluralName: 'jobs';
    singularName: 'job';
  };
  ...
  attributes: {
    ...
    locationType: Schema.Attribute.Enumeration<['Remote', 'Onsite', 'Hybrid']> &
      Schema.Attribute.Required;
    org: Schema.Attribute.String & Schema.Attribute.Required;
    orgKind: Schema.Attribute.String & Schema.Attribute.Required;
    pay: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    requirements: Schema.Attribute.JSON & Schema.Attribute.Required;
    responsibilities: Schema.Attribute.JSON & Schema.Attribute.Required;
    savedBy: Schema.Attribute.Relation<'oneToMany', 'api::saved-job.saved-job'>;
    slug: Schema.Attribute.UID<'title'> & Schema.Attribute.Required;
...
export interface ApiLessonProgressLessonProgress
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    lessonKey: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['Apparel', 'Accessories', 'Electronics', 'Tools', 'Furniture', 'Home']
    > &
      Schema.Attribute.Required;
    condition: Schema.Attribute.Enumeration<['New', 'Used', 'Refurbished']> &
    ...
    > &
      Schema.Attribute.Private;
    maker: Schema.Attribute.String;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    price: Schema.Attribute.Decimal & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    seed: Schema.Attribute.String;
    shopifyUrl: Schema.Attribute.String & Schema.Attribute.Required;
