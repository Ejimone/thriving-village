...
/**
 * Reusable job row. Used on the job board and the dashboard. `initialSaved` is
 * seeded by the caller — see `LiveJobList` for the one-fetch-per-page pattern
 * that hydrates it (never one fetch per card, that doesn't scale past a couple
 * of cards on a page with frequent re-renders, e.g. search-as-you-type).
 */
